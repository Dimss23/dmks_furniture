...
class MejaView extends StatelessWidget {
  final List<String> mejaProductIds = ['3', '9'];
  final ProductViewModel mejaViewModel = ProductViewModel();

  MejaView({super.key});

  @override
  Widget build(BuildContext context) {
    List<Product> mejaProducts =
        mejaProductIds.map((id) => mejaViewModel.getProductById(id)).toList();
    ...
    return Scaffold(
      ...
      body: GridView.builder(
        ...
        itemCount:
            mejaProducts.length, // jumlah barang favorit yang ditampilkan
        itemBuilder: (context, index) {
          Product product = mejaProducts[index];
          return Card(
